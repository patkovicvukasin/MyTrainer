...
import com.mytrainer.backend.dto.GenerateRequest;
...
public class SessionController {
    ...
    public ResponseEntity<List<SessionResponse>> getSessions(
        ...
        Trainer trainer = (Trainer) SecurityContextHolder
    ...
    public ResponseEntity<Void> generateRange(@RequestBody GenerateRequest req) {
        Trainer trainer = (Trainer) SecurityContextHolder
                .getContext().getAuthentication().getPrincipal();
        sessionService.generateSchedule(trainer, req.startDate(), req.endDate());
        return ResponseEntity.noContent().build();
    }
}
